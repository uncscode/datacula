...
#%%
data_path = 'D:\\CloudChamber\\exp20230830'
# make plots folder
...
ax[0].plot(size_bins, conc[:,5], label='50 nm')
ax[0].plot(size_bins, conc[:,-1], label='125 nm')
ax[0].set_yscale('log')
...
ax[1].plot(size_bins, k_apparent_array, label='k apparent')
ax[1].fill_between(
    size_bins,
